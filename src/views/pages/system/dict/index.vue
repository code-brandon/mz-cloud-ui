      ...
      <el-table-column
        ...
        <template v-slot="scope">
          ...
          <el-popover
            ...
            <el-button style="margin-left: 10px" type="text" slot="reference" icon="el-icon-delete" size="mini">删除</el-button>
          </el-popover>
        </template>
      </el-table-column>
    </el-table>
...
<script>
  import {getDictTypePage} from "@/api/system/dict";
  ...
  export default {
    ...
    props: {},
    // 局部注册的组件
    components: {CommonControlCard,CommonSearchReset,DictData},
    // 组件状态值
    data() {
      return {
        param: {
